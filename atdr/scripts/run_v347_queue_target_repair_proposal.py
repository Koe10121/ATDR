...
from atdr.app.detection.v347_queue_target_repair_proposal import run_v347_queue_target_repair_proposal


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run v3.47 queue-target repair proposal diagnostics without writing labels, "
