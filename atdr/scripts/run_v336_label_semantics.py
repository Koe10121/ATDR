...
from atdr.app.detection.v336_label_semantics import run_v336_label_semantics_analysis


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run v3.36 label semantics and SOC queue target redesign diagnostics without "
