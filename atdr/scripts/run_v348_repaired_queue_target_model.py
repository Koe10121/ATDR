...
from atdr.app.detection.v348_repaired_queue_target_model import run_v348_repaired_queue_target_model


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run v3.48 repaired queue-target model diagnostics without writing labels, "
