...
SCENARIOS: dict[str, ScenarioSpec] = {
    ...
    "benign_dns_web_traffic": ScenarioSpec(
        name="benign_dns_web_traffic",
        filename="benign_dns_web_traffic.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="No alerts from routine DNS, web, SSL, and QUIC business traffic.",
    ),
    "benign_incomplete_allow_noise": ScenarioSpec(
        name="benign_incomplete_allow_noise",
        filename="benign_incomplete_allow_noise.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Incomplete allowed web sessions should create parser/data-quality notes but no alert by themselves.",
    ),
    "benign_repeated_internal_service": ScenarioSpec(
        name="benign_repeated_internal_service",
        filename="benign_repeated_internal_service.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Repeated approved internal service traffic should not create a threat alert.",
    ),
    "benign_high_volume_single_service": ScenarioSpec(
        name="benign_high_volume_single_service",
        filename="benign_high_volume_single_service.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Moderate approved single-service transfer traffic should remain below alert threshold.",
    ),
    ...
    "suspicious_horizontal_scan": ScenarioSpec(
        name="suspicious_horizontal_scan",
        filename="suspicious_horizontal_scan.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Horizontal scan-like denied traffic should create a port-scan alert.",
    ),
    ...
    "suspicious_denied_ssh_burst": ScenarioSpec(
        name="suspicious_denied_ssh_burst",
        filename="suspicious_denied_ssh_burst.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Repeated denied SSH attempts should create a brute-force-like alert.",
    ),
    "suspicious_rare_port_probe": ScenarioSpec(
        name="suspicious_rare_port_probe",
        filename="suspicious_rare_port_probe.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Denied outside-to-inside rare-port probing should create a policy/suspicious access alert.",
    ),
    ...
    "malicious_like_c2_beacon": ScenarioSpec(
        name="malicious_like_c2_beacon",
        filename="malicious_like_c2_beacon.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Repeated unusual outbound beacon-like traffic should create a malware/C2-style alert.",
    ),
    ...
    "malicious_like_exfiltration_burst": ScenarioSpec(
        name="malicious_like_exfiltration_burst",
        filename="malicious_like_exfiltration_burst.txt",
        default_source_type="firewall",
        default_parser_profile="palo_alto",
        expected="Large outbound transfer burst should create an exfiltration-suspicion alert.",
    ),
    ...
    "malformed_vendor_mixed_fields": ScenarioSpec(
        name="malformed_vendor_mixed_fields",
        filename="malformed_vendor_mixed_fields.txt",
        default_source_type="sample",
        default_parser_profile="palo_alto",
        expected="Malformed vendor-like rows should preserve evidence and warnings without crashing.",
    ),
