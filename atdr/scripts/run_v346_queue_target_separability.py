...
from atdr.app.detection.v346_queue_target_separability import run_v346_queue_target_separability


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run v3.46 queue-target separability diagnostics without writing labels, "
