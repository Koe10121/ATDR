...
from atdr.app.detection.v349_repaired_queue_severity_model import run_v349_repaired_queue_severity_model


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run v3.49 repaired-queue severity diagnostics without writing labels, "
