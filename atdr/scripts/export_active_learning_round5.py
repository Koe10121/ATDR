...
from atdr.app.services.active_learning_service import (
    DEFAULT_ACTIVE_LEARNING_ROUND5_BOUNDARY_PATH,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export ATDR active-learning round 5 for suspicious/malicious boundary review."
    )
    parser.add_argument("--limit", type=int, default=200)
    parser.add_argument("--focus", default="malicious,suspicious,needs_context")
    parser.add_argument("--output", default=str(DEFAULT_ACTIVE_LEARNING_ROUND5_BOUNDARY_PATH))
