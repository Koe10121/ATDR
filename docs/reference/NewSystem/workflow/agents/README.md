...
เอกสารชุดนี้คือ operating manual สำหรับใช้ agents พัฒนาและดูแล NewSystem. ทุก agent ต้องยึด `docs/reference/NewSystem/workflow/AI-WORKFLOW.md`, source code ปัจจุบัน, route mount จริง, frontend route/API จริง และ permission model ที่มีอยู่ ไม่ใช่ prompt ทั่วไป.

## Source Documents

| Source | Purpose |
|---|---|
| `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` | workflow, gates, T1-T20, no-guessing/test/PRD rules |
| `docs/reference/NewSystem/workflow/PRD-NewSystem.md` | product requirement baseline |
...
- Follow `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` before role-specific instructions.
...
- Update `docs/reference/NewSystem/workflow/PRD-NewSystem.md` when behavior, API, UI, data, permission, test, or release contract changes.
