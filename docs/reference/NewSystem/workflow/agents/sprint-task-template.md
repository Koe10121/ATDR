...
This template complements `docs/reference/NewSystem/workflow/AI-WORKFLOW.md`. Any implementation/change handoff must also complete the T1-T20 format in `docs/reference/NewSystem/workflow/T1-T20-change-document.md`.
...
| Existing tests | |
| Existing docs | |
| AI workflow | `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` |
| PRD | `docs/reference/NewSystem/workflow/PRD-NewSystem.md` |
