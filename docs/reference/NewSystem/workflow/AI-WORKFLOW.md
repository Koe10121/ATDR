...
| 3 | `docs/reference/NewSystem/workflow/PRD-NewSystem.md` | product requirement truth |
...
Update `docs/reference/NewSystem/workflow/PRD-NewSystem.md` when any of these change:
...
Template file: `docs/reference/NewSystem/workflow/T1-T20-change-document.md`
