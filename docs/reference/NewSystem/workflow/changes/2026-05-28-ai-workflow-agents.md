...
- The historical NewSystem root agent instruction only had backend route style rules; that root file is not part of this selected archive.
- Repo has no previous `docs/reference/NewSystem/workflow/AI-WORKFLOW.md`.
...
- add `docs/reference/NewSystem/workflow/AI-WORKFLOW.md`
- add T1-T20 template
- add NewSystem PRD baseline
- update the historical NewSystem root agent instruction
...
| AC-NEW-004 | FR-NEW-004 | API/UI/data/permission behavior changes | before release | `docs/reference/NewSystem/workflow/PRD-NewSystem.md` is updated or documented as not needed |
...
| File | Change |
|---|---|
| `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` | added master workflow, rules, gates, repo style, T1-T20 |
| `docs/reference/NewSystem/workflow/T1-T20-change-document.md` | added reusable T1-T20 template |
| `docs/reference/NewSystem/workflow/PRD-NewSystem.md` | added source-aligned PRD baseline |
| Historical NewSystem root agent instruction (not preserved) | pointed agents to workflow and added mandatory rules |
| `docs/reference/NewSystem/workflow/agents/README.md` | linked workflow/PRD and global rules |
| `docs/reference/NewSystem/workflow/agents/agent-00-orchestrator.md` | added workflow/PRD/T1-T20 source gates |
| `docs/reference/NewSystem/workflow/agents/agent-01-product-owner.md` | added PRD/T1-T20 responsibility |
| `docs/reference/NewSystem/workflow/agents/agent-02-data-model.md` | added workflow/PRD and source-verified data contract rules |
| `docs/reference/NewSystem/workflow/agents/agent-03-backend.md` | added source/test/PRD/T1-T20 backend gates |
| `docs/reference/NewSystem/workflow/agents/agent-04-frontend.md` | added component-based frontend rules |
| `docs/reference/NewSystem/workflow/agents/agent-05-security-iam.md` | added workflow/PRD/T1-T20 review evidence |
| `docs/reference/NewSystem/workflow/agents/agent-06-qa-uat.md` | added workflow/PRD/T1-T20 test evidence |
| `docs/reference/NewSystem/workflow/agents/agent-07-release-ops.md` | added PRD/docs release sign-off |
| `docs/reference/NewSystem/workflow/agents/sprint-task-template.md` | added workflow/PRD and T1-T20 task |
| `docs/reference/NewSystem/workflow/agents/orchestrator-example.md` | added workflow/PRD and T1-T20 handoff task |

## T16 Tests Run / Evidence

| Command | Result | Evidence / Notes |
|---|---|---|
| `for f in docs/reference/NewSystem/workflow/AI-WORKFLOW.md ... frontend-vue/src/service/api.js; do test -f "$f"; done` | pass | all key references, including this change document, returned `OK` |
...
| `find docs -maxdepth 3 -type f` | pass | new docs listed under `docs/reference/NewSystem/workflow/AI-WORKFLOW.md`, `docs/prd`, `docs/templates`, `docs/agents` |
...
|---|---|---|
| `docs/reference/NewSystem/workflow/PRD-NewSystem.md` | yes | created baseline product PRD and PRD update rules |
| `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` | yes | created master workflow |
| `docs/reference/NewSystem/workflow/T1-T20-change-document.md` | yes | created required change document template |
| `docs/agents/*` | yes | aligned agents with workflow and repo style |
| Historical NewSystem root agent instruction (not preserved) | yes | linked root instruction to workflow |

## T18 Risks / Blockers / Assumptions / Decisions

| ID | Type | Description | Owner | Status |
|---|---|---|---|---|
| D-001 | Decision | `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` is the primary workflow; role files are subordinate | Orchestrator | closed |
| D-002 | Decision | `docs/reference/NewSystem/workflow/PRD-NewSystem.md` is the active PRD baseline; older backend PRD is historical/reference | Product Owner | closed |
...
Status: Done
Changed files: docs/reference/NewSystem/workflow/AI-WORKFLOW.md, docs/reference/NewSystem/workflow/T1-T20-change-document.md, docs/reference/NewSystem/workflow/PRD-NewSystem.md, the historical root agent instruction, and docs/reference/NewSystem/workflow/agents/*
