...
| Related workflow | `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` |
| Related agents | `docs/reference/NewSystem/workflow/agents/README.md` |
...
Use `docs/reference/NewSystem/workflow/AI-WORKFLOW.md` section `T1-T20` for change documentation.
