...
| FR-ALT-01 analyst workflow | alert/case/label/audit routes and React pages | end-to-end analyst journey and UI tests | Implemented locally |
...
| FR-IAM-01 identity | shell handoff, auth/security services, shell lifecycle scripts | auth, handoff, config-doctor, startup, and browser tests | Locally implemented; MFU acceptance external |
| FR-OPS-01 operations | health/metrics, durable jobs, backup/restore, deploy assets | PostgreSQL CI, recovery, performance, release, and security gates | Repository-ready; host acceptance external |
...
host, a physical teammate exercise, and independent physical-source detection
