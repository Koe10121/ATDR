...
const statusClass: Record<string, string> = {
  ...
  needs_more_context: "border-purple-400/40 bg-purple-400/10 text-purple-300",
  ...
  local: "border-slate-400/30 bg-slate-400/10 text-slate-300",
  external: "border-cyan/30 bg-cyan/10 text-cyan",
  "Local login only": "border-slate-400/30 bg-slate-400/10 text-slate-300",
  ...
  "Not Production Promoted": "border-slate-400/30 bg-slate-400/10 text-slate-300",
  ...
  "No Email": "border-slate-400/30 bg-slate-400/10 text-slate-300",
  ...
  "Final Controlled Validation Candidate": "border-success/30 bg-success/10 text-success",
  "Not Production Ready": "border-slate-400/30 bg-slate-400/10 text-slate-300",
  ...
  "Shadow Observation": "border-slate-400/30 bg-slate-400/10 text-slate-300",
  ...
  "Shadow Scoring Disabled": "border-slate-400/30 bg-slate-400/10 text-slate-300",
