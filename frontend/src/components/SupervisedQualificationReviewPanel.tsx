...
function ReviewForm({
  ...
  return (
    <section className="panel min-w-0" data-testid="qualification-review-form">
      ...
      <form className="mt-4 space-y-4" onSubmit={submit}>
        <label className="block text-sm font-bold">
          Final decision
          <SafeSelect
            ariaLabel="Supervised qualification final decision"
            className="mt-2"
        ...
        {save.isError ? <ErrorBanner error={save.error} fallback="Unable to save this qualification decision." /> : null}
        {!item.closed ? (
